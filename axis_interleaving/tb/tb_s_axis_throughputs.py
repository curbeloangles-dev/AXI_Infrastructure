...
# when there are differents throughputs in the slave axi stream inputs.
#
# =============================================================================
# Libraries
# =============================================================================
...
async def start_sending_data_ch1(tb, channel_data, capture_size):
    global in_init_time_ch1, in_last_time_ch1
...
async def throughputs(dut):
    """
        Data arrives to the inputs in the same rising edge.
        Channels one and three have lower throughputs than the other channels.
